...
import "./ItemCoffeeToolsEleven.css"


const ItemCoffeeToolsEleven = () => {
  const {id = 11} = useParams()
  const item = DataCoffeetools.find(p => p.id === parseInt(id))
  return (
    <div>
        <div className="div-item-ict11">
                <div className="div__main_ict_item11">
                ...
                <div className="title-item_ictone">
                  <div>
                    <p>
                    Bundle includes one 250g Airscape Canister and one 250g bag of our most popular coffee, the Superior blend.
                    </p>
                  </div>
                  <div>
                      <h2>
...
export default ItemCoffeeToolsEleven