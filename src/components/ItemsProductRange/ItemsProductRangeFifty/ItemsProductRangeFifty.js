...
import "./ItemsProductRangeFifty.css"


const ItemsProductRangeFifty = () => {
  const {id = 62} = useParams()
  const item = DataProductRange.find(p => p.id === parseInt(id))
  return (
    <div>
        <div className="div-item-ipr47">
                <div className="div-main-item-ipr47">
                    <div className="img-item-fortyseven-ipr">
                        <img src={item.img}/>
                    </div>
                    <div className="factor-item-ipr47">
                        <div className="div-main-factor-ipr47">
                ...
                <div className="title-item-won">
                  ...
                  <div>
                    <h2>DESCRIPTION</h2>
                    <p>
                      Enjoy classic Italian espresso with the Bialetti 6 Cup. This iconic stovetop espresso maker brews rich, full-bodied coffee with ease, featuring a durable aluminium design and a simple, effective brewing process.
                    </p>
                  </div>
                  <div>
...
export default ItemsProductRangeFifty