...
import "./ItemsProductRangeFiftyThree.css"

const ItemsProductRangeFiftyThree = () => {
  const {id = 68} = useParams()
  const item = DataProductRange.find(p => p.id === parseInt(id))
  return (
    <div>
        <div className="div-item-ipr50">
                <div className="div-main-item-ipr50">
                    <div className="img-item-fifty-ipr">
                        <img src={item.img}/>
                    </div>
                    <div className="factor-item-ipr50">
                        <div className="div-main-factor-ipr50">
                ...
                <div className="title-item-won">
                  <div>
                    ...
                    <p>
                      250g of our Campos Dark City Blend: Choose either beans or your preferred grind.

                      250g Airscape Canister: Compact canister that expels air to keep coffee fresh, made from durable galvanized steel.
                    </p>
                  </div>
                  <div>
                    <h2>DESCRIPTION</h2>
...
export default ItemsProductRangeFiftyThree