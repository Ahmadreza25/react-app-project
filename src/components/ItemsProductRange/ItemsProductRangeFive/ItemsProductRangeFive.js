...
const ItemsProductRangeFive = () => {
    const {id = 5} = useParams()
    const item = DataProductRange.find(p => p.id === parseInt(id))
  return (
    <div>
        <div className="div-item-ipr-5">
                <div className="div-main-item-ipr5">
                    <div className="img-item-five-ipr">
                        <img src={item.img}/>
                    </div>
                    <div className="factor-item-ipr5">
                        <div className="div-main-factor-ipr5">
...
export default ItemsProductRangeFive