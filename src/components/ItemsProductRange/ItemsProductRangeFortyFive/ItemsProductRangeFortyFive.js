...
import "./ItemsProductRangeFortyFive.css"

const ItemsProductRangeFortyFive = () => {
  const {id = 54} = useParams()
  const item = DataProductRange.find(p => p.id === parseInt(id))
  return (
    <div>
        <div className="div-item-ipr42">
                <div className="div-main-item-ipr42">
                    <div className="img-item-fortytwo-ipr">
                        <img src={item.img}/>
                    </div>
                    <div className="factor-item-ipr42">
                        <div className="div-main-factor-ipr42">
                ...
                <div className="title-item-won">
                  <div>
                    ...
                    <p>
                      1 x Hario V60 white porcelain 2 cup
                    </p>
                  </div>
                  <div>
                    <h2>DESCRIPTION</h2>
                    <p>
                      Elevate your pour-over coffee with the Hario V60 Porcelain 2 Cup. This elegant dripper is crafted from high-quality porcelain, providing even heat distribution and a smooth, consistent extraction for a perfect cup of coffee.
                    </p>
                  </div>
                  <div>
...
export default ItemsProductRangeFortyFive