...
import "./ItemsProductRangeFortyFour.css";

const ItemsProductRangeFortyFour = () => {
    const {id = 44} = useParams()
    const item = DataProductRange.find(p => p.id === parseInt(id))
  return (
    <div>
        <div className="div-item-ipr41">
                <div className="div-main-item-ipr41">
                    <div className="img-item-fortyone-ipr">
                        <img src={item.img}/>
                    </div>
                    <Div height="700px" marginbot="-350px">
                        <div className="div-main-factor-ipr41">
                ...
                <div className="title-item-won">
                  <div>
                    ...
                    <p>
                      1 x Chemex 6 Cup Classic Filter Drip Coffee Maker
                    </p>
                  </div>
                  <div>
                    <h2>DESCRIPTION</h2>
                    <p>
                      Brew a small batch of classic coffee with the Chemex 6 Cup Classic Filter Drip Coffee Maker. Its elegant design and thick paper filters ensure a clean, rich cup of coffee with every brew. Ideal for those who appreciate both style and quality.
                    </p>
                  </div>
                  <div>
...
export default ItemsProductRangeFortyFour