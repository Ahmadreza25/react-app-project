...
import "./ItemsProductRangeFortyOne.css";

const ItemsProductRangeFortyOne = () => {
  const {id = 49} = useParams()
  const item = DataProductRange.find(p => p.id === parseInt(id))
  return (
    <div>
        <div className="div-item-ipr-38">
                <div className="div-main-item-ipr38">
                    <div className="img-item-thirtyeight-ipr">
                        <img src={item.img}/>
                    </div>
                    <div className="factor-item-ipr38">
                        <div className="div-main-factor-ipr38">
                ...
                <div className="title-item-won">
                    <div>
                      <h2>WHAT'S INCLUDED</h2>
                        <p>
                        1 x Pullman Coffee Tamper
                        </p>
                    </div>
                    <div>
                      <h2>DESCRIPTION</h2>
                      <p>
                        Achieve the perfect espresso with the Pullman Coffee Tamper. Designed for precision and comfort, this tamper ensures an even press for optimal extraction and a richer, more balanced espresso shot.
                      </p>
                    </div>
                    <div>
...
export default ItemsProductRangeFortyOne