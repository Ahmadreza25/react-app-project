...
import "./ItemsProductRangeFortySeven.css"


const ItemsProductRangeFortySeven = () => {
  const {id = 59} = useParams()
  const item = DataProductRange.find(p => p.id === parseInt(id))
  return (
    <div>
        <div className="div-item-ipr44">
                <div className="div-main-item-ipr44">
                    <div className="img-item-fortyfour-ipr">
                        <img src={item.img}/>
                    </div>
                    <div className="factor-item-ipr44">
                        <div className="div-main-factor-ipr44">
                ...
                <div className="title-item-won">
                  <div>
                    <h2>DESCRIPTION</h2>
                    <p>
                    The V60 Pour Over by Hario is a very easy to use, highly customisable and satisfying method of making 
                    coffee.The V60 will reward the meticulous barista as it becomes highly Sensitive to changes in technique and is a perfect match with all of our filter coffee offerings.
                    </p>
                  </div>
                  <div>
...
export default ItemsProductRangeFortySeven