...
import "./ItemsProductRangeFourteen.css"

const ItemsProductRangeFourteen = () => {
  const {id = 17} = useParams()
  const item = DataProductRange.find(p => p.id === parseInt(id))
  return (
    <div>
          <div className="div-item-ipr-14">
                <div className="div-main-item-ipr14">
                    <div className="img-item-fourteen-ipr">
                        <img src={item.img}/>
                    </div>
                    <div className="factor-item-ipr14">
                        <div className="div-main-factor-ipr14">
                ...
                <div className="title-item-won">
                    ...
                    <div>
                        <h2>DESCRIPTION</h2>
                        <p>
                          Experience ultimate coffee freshness with our 1kg Superior Blend paired with the 
                          Airscape Canister. Our Superior Blend is a carefully crafted mix of specialty coffees 
                          from Colombia, East Africa, and Brazil, delivering a full-bodied coffee with notes of sweet caramel, red currant, and milk chocolate. The farms we partner with are leaders in the specialty coffee world, ensuring you receive only the best quality beans.

                          The Airscape Canister is designed to keep your coffee as fresh as the day it was roasted. 
                          By forcing out air, it extends the life of your coffee, so you can enjoy the rich, 
                          consistent flavours of our Superior Blend cup after cup. The canister is made of durable, restaurant-grade galvanised steel, and the BPA-free clear top lid lets you see how much coffee you have left. The inner Airscape lid makes a satisfying "swooshing" noise as it locks out air, ensuring your coffee stays fresh. This bundle is perfect for coffee 
                          lovers who demand the best in both flavour and freshness.
                        </p>
                    </div>
                    <div>
...
export default ItemsProductRangeFourteen