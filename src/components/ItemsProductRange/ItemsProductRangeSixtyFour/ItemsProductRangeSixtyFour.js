...
import "./ItemsProductRangeSixtyFour.css"
const ItemsProductRangeSixtyFour = () => {
  const {id = 85} = useParams()
  const item = DataProductRange.find(p => p.id === parseInt(id))
  return (
    <div>
        <div className="div-item-ipr61">
                <div className="div-main-item-ipr61">
                    <div className="img-item-sixtyone-ipr">
                        <img src={item.img}/>
                    </div>
                    <div className="factor-item-ipr61">
                        <div className="div-main-factor-ipr61">
...
export default ItemsProductRangeSixtyFour