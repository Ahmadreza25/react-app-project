...
import "./ItemsProductRangeTwelve.css"

const ItemsProductRangeTwelve = () => {
  const {id = 12} = useParams()
  const item = DataProductRange.find(p => p.id === parseInt(id))
  return (
    <div>
          <div className="div-item-ipr-12">
                <div className="div-main-item-ipr12">
                    <div className="img-item-twelve-ipr">
                        <img src={item.img}/>
                    </div>
                    <Div  height="1000px" marginbot="-550px">
                        <div className="div-main-factor-ipr12">
                ...
                <div className="title-item-won">
                  <div>
                    ...
                    <p>
                      ...
                      Notes of citrus fruits, jasmine honeysuckle and red apple are just some of the flavours which shine through in this delicious blend.

                      These fruit and floral flavour characteristics are synonymous with some of the most premium coffee varieties in the world.
                    </p>
                  </div>
                  <div>
...
export default ItemsProductRangeTwelve
