...
import "./ItemsProductRangeTwentyThree.css"

const ItemsProductRangeTwentyThree = () => {
  const {id = 23} = useParams()
  const item = DataProductRange.find(p => p.id === parseInt(id))
  return (
    <div>
        <div className="div-item-ipr-20">
                <div className="div-main-item-ipr20">
                    <div className="img-item-twenty-ipr">
                        <img src={item.img}/>
                    </div>
                    <div className="factor-item-ipr20">
                        <div className="div-main-factor-ipr20">
                ...
                <div>
                      ...
                      <p>
                        1 x Pack of 350 micro filters
                      </p>
                    </div>
                    <div>
                      <h2>DESCRIPTION</h2>
                      <p>
                        Experience a smoother, grit-free cup with the Aeropress Micro Filters. This pack of 350 ensures you'll always have a fresh, clean filter on hand. Ideal for use with the Aeropress coffee maker, these filters 
                        provide consistent results every time, enhancing the purity and flavour of your brew.
                      </p>
                    </div>
                    <div>
...
export default ItemsProductRangeTwentyThree