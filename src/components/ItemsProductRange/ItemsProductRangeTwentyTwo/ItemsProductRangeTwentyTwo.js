...
import "./ItemsProductRangeTwentyTwo.css"

const ItemsProductRangeTwentyTwo = () => {
  const {id = 22} = useParams()
  const item = DataProductRange.find(p => p.id === parseInt(id))
  return (
    <div>
        <div className="div-item-ipr-19">
                <div className="div-main-item-ipr19">
                    <div className="img-item-nineteen-ipr">
                        <img src={item.img}/>
                    </div>
                    <div className="factor-item-ipr19">
                        <div className="div-main-factor-ipr19">
                ...
                <div>
                      ...
                      <p>
                        1 x 600mL Cold brew pot
                      </p>
                    </div>
                    <div>
                      <h2>DESCRIPTION</h2>
                      <p>
                        Craft refreshing cold brew coffee with the Hario Mizudashi Cold Brew Pot. This 600ml pot features a fine mesh filter for smooth, rich coffee 
                        without sediment. Its stylish design is perfect for brewing and serving chilled coffee beverages.
                      </p>
                    </div>
                    <div>
...
export default ItemsProductRangeTwentyTwo